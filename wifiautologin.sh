...
username="这里输入账号"
password="这里输入密码"
channelshow="%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8"  #中国移动
#channelshow="%E4%B8%AD%E5%9B%BD%E7%94%B5%E4%BF%A1" #中国电信
while :
do
    ...
    then
            ...
            DATA="username="$username"&password="$password"&channelshow="$channelshow"&channel=%40cmcc&lt="$LT"&execution="$EXEC"&_eventId=submit&login=%E7%99%BB%E5%BD%95"
